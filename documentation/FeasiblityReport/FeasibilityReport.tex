...
\vspace{0.2cm}
    ...
    It is an interface for the various Pharmacies which are interested in selling their products on our Platform. The seller will be required to register and then he/she will be able to list and sell his/her products in a few simple steps. Following are the functional requirements of the Pharmacy interface:
